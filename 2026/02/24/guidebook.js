...
const CATEGORIES = {
    ...
    "亚洲食品": { icon: "textures/items/fried_rice", items: {
        ...
        "猪肉味噌汤": { icon: "textures/items/tonjiru", desc: "丰盛的猪肉蔬菜味噌汤。", obtain: "熟猪排、胡萝卜、土豆、水桶、钢碗.", hunger: "7 (3.5 点)", saturation: "1.6 (Good)", other: "Only stacks to 1", recipe: "§l§6食谱:§r §7工作台§r\n[Cooked Porkchop][Carrot][Potato]\n[Water Bucket][Steel Bowl][ ]\n§7= Tonjiru x1 + Bucket x1§r" },
        "Ramen Stew": { icon: "textures/items/ramen_stew", desc: "A rich, savory bowl of ramen noodles in broth.", obtain: "Cooked Chicken, Carrot, Ramen Noodles, Steel Bowl, Water Bucket.", hunger: "8 (4 点)", saturation: "1.6 (Good)", other: "Only stacks to 1", recipe: "§l§6食谱:§r §7工作台§r\n[熟鸡肉][ ][胡萝卜]\n[ ][拉面][ ]\n[钢碗][ ][水桶]\n§7= 拉面炖汤 x1 + 桶 x1§r" },
        ...
        "Lavender Wagashi": { icon: "textures/items/lavender_wagashi", desc: "A delicate Japanese confection flavored with lavender.", obtain: "Sugar, Wheat, Purple Dye, Water Bucket.", hunger: "4 (2 点)", saturation: "1.6 (Good)", recipe: "§l§6食谱:§r §7工作台§r\n[Sugar][ ]\n[Wheat][Purple Dye]\n[Water Bucket][ ]\n§7= Lavender Wagashi x1 + Bucket x1§r" },
        "Lime Wagashi": { icon: "textures/items/lime_wagashi", desc: "A refreshing citrus wagashi with a bright green color.", obtain: "Sugar, Wheat, Lime Dye, Water Bucket.", hunger: "4 (2 点)", saturation: "1.6 (Good)", recipe: "§l§6食谱:§r §7工作台§r\n[Sugar][ ]\n[Wheat][Lime Dye]\n[Water Bucket][ ]\n§7= Lime Wagashi x1 + Bucket x1§r" },
        "Pink Wagashi": { icon: "textures/items/pink_wagashi", desc: "A sweet pink wagashi with a floral taste.", obtain: "Sugar, Wheat, Pink Dye, Water Bucket.", hunger: "4 (2 点)", saturation: "1.6 (Good)", recipe: "§l§6食谱:§r §7工作台§r\n[Sugar][ ]\n[Wheat][Pink Dye]\n[Water Bucket][ ]\n§7= Pink Wagashi x1 + Bucket x1§r" },
        "Sunset Wagashi": { icon: "textures/items/yellow_red_wagashi", desc: "A two-toned wagashi with warm sunset colors.", obtain: "Sugar, Wheat, Red Dye, Water Bucket, Yellow Dye.", hunger: "4 (2 点)", saturation: "1.2 (Normal)", other: "30 percent compost chance", recipe: "§l§6食谱:§r §7工作台§r\n[Sugar][ ]\n[Wheat][Red Dye]\n[Water Bucket][Yellow Dye]\n§7= Sunset Wagashi x1 + Bucket x1§r" }
    }},
    ...
    "Baked Goods": { icon: "textures/items/sweet_berry_pie", subcategories: {
        ...
        "Breads & Pastries": { icon: "textures/items/croissant", items: {
            "Loaf Bread": { icon: "textures/items/loaf_bread", desc: "A fresh loaf of bread. Can be sliced. Eats 2x as slow.", obtain: "Wheat x6.", hunger: "8 (4 点)", saturation: "1.6 (Good)", other: "Eats 2x as slow\n100 percent compost chance", recipe: "§l§6食谱:§r §7工作台§r\n[Wheat][Wheat][Wheat]\n[Wheat][Wheat][Wheat]\n§7= Loaf Bread x1§r" },
            ...
            "Pumpkin Bread": { icon: "textures/items/pumpkin_bread", desc: "Moist spiced bread with pumpkin.", obtain: "Wheat x2 + Sugar + Pumpkin (无特定摆放).", hunger: "5 (2.5 点)", saturation: "1.6 (Good)", other: "100 percent compost chance", recipe: "§l§6食谱:§r §7工作台 (无特定摆放)§r\n[Wheat] + [Wheat] + [Sugar] + [Pumpkin]\n§7= Pumpkin Bread x1§r" },
            "Croissant": { icon: "textures/items/croissant", desc: "A buttery, flaky French pastry.", obtain: "Sugar x2, Wheat x3, Butter.", hunger: "5 (2.5 点)", saturation: "1.6 (Good)", other: "85 percent compost chance", recipe: "§l§6食谱:§r §7工作台§r\n[Sugar][ ][Sugar]\n[Wheat][Butter][Wheat]\n[ ][Wheat][ ]\n§7= Croissant x2§r" },
            "Sugar Roll": { icon: "textures/items/sugar_roll", desc: "A soft rolled pastry coated in sugar.", obtain: "Sugar x3, Butter x2, Wheat.", hunger: "6 (3 点)", saturation: "0.6 (Low)", other: "100 percent compost chance", recipe: "§l§6食谱:§r §7工作台§r\n[Sugar][Sugar][Sugar]\n[Butter][Wheat][Butter]\n§7= Sugar Roll x1§r" },
            "Bagel": { icon: "textures/items/bagel", desc: "A chewy ring-shaped bread roll.", obtain: "Wheat x2, Salt x2, Water Bucket.", hunger: "5 (2.5 点)", saturation: "1.6 (Good)", recipe: "§l§6食谱:§r §7工作台§r\n[ ][Wheat][ ]\n[Salt][Water Bucket][Salt]\n[ ][Wheat][ ]\n§7= Bagel x1 + Bucket x1§r" },
            "Pretzel": { icon: "textures/items/pretzel", desc: "A salted, twisted bread snack.", obtain: "Salt, Butter x2, Wheat x3.", hunger: "5 (2.5 点)", saturation: "1.6 (Good)", other: "85 percent compost chance", recipe: "§l§6食谱:§r §7工作台§r\n[ ][Salt][ ]\n[Butter][ ][Butter]\n[Wheat][Wheat][Wheat]\n§7= Pretzel x3§r" },
            "Churro": { icon: "textures/items/churro", desc: "A fried dough stick coated in cinnamon sugar. Held like a sword.", obtain: "Cinnamon + Wheat + Sugar (无特定摆放).", hunger: "3 (1.5 点)", saturation: "0.6 (Low)", other: "Held like a sword\n50 percent compost chance", recipe: "§l§6食谱:§r §7工作台 (无特定摆放)§r\n[Cinnamon] + [Wheat] + [Sugar]\n§7= Churro x1§r" }
        }},
        "Muffins": { icon: "textures/items/sweet_berry_muffin", items: {
            "Sweet Berry Muffin": { icon: "textures/items/sweet_berry_muffin", desc: "A fluffy muffin bursting with sweet berries.", obtain: "Sweet Berries, Wheat, Egg (any type), Sugar.", hunger: "6 (3 点)", saturation: "0.6 (Low)", other: "100 percent compost chance", recipe: "§l§6食谱:§r §7工作台§r\n[ ][Sweet Berries][ ]\n[Wheat][Egg][Sugar]\n§7= Sweet Berry Muffin x1§r" },
            "Chocolate Muffin": { icon: "textures/items/chocolate_muffin", desc: "A rich chocolate muffin with cocoa chunks.", obtain: "Cocoa Beans, Wheat, Egg (any type), Sugar.", hunger: "6 (3 点)", saturation: "1.6 (Good)", other: "100 percent compost chance", recipe: "§l§6食谱:§r §7工作台§r\n[ ][Cocoa Beans][ ]\n[Wheat][Egg][Sugar]\n§7= Chocolate Muffin x1§r" },
            "Beetroot Muffin": { icon: "textures/items/beetroot_muffin", desc: "A surprisingly sweet muffin with beetroot.", obtain: "Beetroot, Wheat, Egg (any type), Sugar.", hunger: "6 (3 点)", saturation: "0.6 (Low)", other: "100 percent compost chance", recipe: "§l§6食谱:§r §7工作台§r\n[ ][Beetroot][ ]\n[Wheat][Egg][Sugar]\n§7= Beetroot Muffin x1§r" },
            "Inkberry Muffin": { icon: "textures/items/inkberry_muffin", desc: "A dark muffin with inkberry pieces.", obtain: "Inkberries, Wheat, Egg (any type), Sugar.", hunger: "6 (3 点)", saturation: "0.6 (Low)", other: "100 percent compost chance", recipe: "§l§6食谱:§r §7工作台§r\n[ ][Inkberries][ ]\n[Wheat][Egg][Sugar]\n§7= Inkberry Muffin x1§r" },
            "Poppyseed Muffin": { icon: "textures/items/poppyseed_muffin", desc: "A classic muffin topped with poppy seeds.", obtain: "Poppy, Wheat, Egg (any type), Sugar.", hunger: "6 (3 点)", saturation: "0.6 (Low)", other: "100 percent compost chance", recipe: "§l§6食谱:§r §7工作台§r\n[ ][Poppy][ ]\n[Wheat][Egg][Sugar]\n§7= Poppyseed Muffin x1§r" }
        }},
        "Donuts": { icon: "textures/items/chocolate_donut", items: {
            "Donut": { icon: "textures/items/donut", desc: "A plain ring donut with a golden glaze.", obtain: "Sugar x5, Egg (any type), Wheat x3.", hunger: "4 (2 点)", saturation: "1.2 (Normal)", other: "100 percent compost chance", recipe: "§l§6食谱:§r §7工作台§r\n[Sugar][Sugar][Sugar]\n[Sugar][Egg][Sugar]\n[Wheat][Wheat][Wheat]\n§7= Donut x1§r" },
            "Sweet Berry Donut": { icon: "textures/items/sweet_berry_donut", desc: "A donut glazed with sweet berry icing.", obtain: "Sugar x3, Sweet Berries x2, Egg (any type), Wheat x3.", hunger: "6 (3 点)", saturation: "1.2 (Normal)", other: "100 percent compost chance", recipe: "§l§6食谱:§r §7工作台§r\n[Sugar][Sugar][Sugar]\n[Sweet Berries][Egg][Sweet Berries]\n[Wheat][Wheat][Wheat]\n§7= Sweet Berry Donut x1§r" },
            "Inkberry Donut": { icon: "textures/items/inkberry_donut", desc: "A donut with dark inkberry glaze.", obtain: "Sugar x3, Inkberries x2, Egg (any type), Wheat x3.", hunger: "6 (3 点)", saturation: "1.2 (Normal)", other: "100 percent compost chance", recipe: "§l§6食谱:§r §7工作台§r\n[Sugar][Sugar][Sugar]\n[Inkberries][Egg][Inkberries]\n[Wheat][Wheat][Wheat]\n§7= Inkberry Donut x1§r" },
            "Chocolate Donut": { icon: "textures/items/chocolate_donut", desc: "A donut dipped in rich chocolate.", obtain: "Sugar x3, Cocoa Beans x2, Egg (any type), Wheat x3.", hunger: "6 (3 点)", saturation: "1.2 (Normal)", other: "100 percent compost chance", recipe: "§l§6食谱:§r §7工作台§r\n[Sugar][Sugar][Sugar]\n[Cocoa Beans][Egg][Cocoa Beans]\n[Wheat][Wheat][Wheat]\n§7= Chocolate Donut x1§r" },
            "Cream Donut": { icon: "textures/items/cream_donut", desc: "A donut filled with sweet cream.", obtain: "Sugar x2, Milk Bottle, Cocoa Beans x2, Egg (any type), Wheat x3.", hunger: "6 (3 点)", saturation: "1.2 (Normal)", other: "100 percent compost chance", recipe: "§l§6食谱:§r §7工作台§r\n[Sugar][Milk Bottle][Sugar]\n[Cocoa Beans][Egg][Cocoa Beans]\n[Wheat][Wheat][Wheat]\n§7= Cream Donut x1 + Glass Milk Bottle x1§r" }
        }},
        "Cookies & Brownies": { icon: "textures/items/chocolate_cookie", items: {
            "Carrot Cookie": { icon: "textures/items/carrot_cookie", desc: "A healthy-ish cookie with shredded carrot.", obtain: "Wheat x2 + Carrot.", hunger: "6 (3 点)", saturation: "1.2 (Normal)", other: "30 percent compost chance", recipe: "§l§6食谱:§r §7工作台§r\n[Wheat][Carrot][Wheat]\n§7= Carrot Cookie x8§r" },
            "Beetroot Cookie": { icon: "textures/items/beetroot_cookie", desc: "A pink cookie with beetroot flavor.", obtain: "Wheat x2 + Beetroot.", hunger: "4 (2 点)", saturation: "1.2 (Normal)", other: "30 percent compost chance", recipe: "§l§6食谱:§r §7工作台§r\n[Wheat][Beetroot][Wheat]\n§7= Beetroot Cookie x8§r" },
            "Chocolate Cookie": { icon: "textures/items/chocolate_cookie", desc: "A classic chocolate chip cookie.", obtain: "Cocoa Beans x2 + Wheat.", hunger: "4 (2 点)", saturation: "1.2 (Normal)", other: "30 percent compost chance", recipe: "§l§6食谱:§r §7工作台§r\n[Cocoa Beans][Wheat][Cocoa Beans]\n§7= Chocolate Cookie x8§r" },
            ...
            "Brownie": { icon: "textures/items/brownie", desc: "A dense, fudgy chocolate brownie.", obtain: "Wheat + Sugar + Cocoa Beans + Butter (无特定摆放).", hunger: "6 (3 点)", saturation: "0.6 (Low)", other: "100 percent compost chance", recipe: "§l§6食谱:§r §7工作台 (无特定摆放)§r\n[Wheat] + [Sugar] + [Cocoa Beans] + [Butter]\n§7= Brownie x1§r" },
            "Beetroot Brownie": { icon: "textures/items/beetroot_brownie", desc: "A brownie with hidden beetroot for moisture.", obtain: "Wheat + Sugar + Beetroot + Cocoa Beans + Butter (无特定摆放).", hunger: "6 (3 点)", saturation: "0.6 (Low)", other: "100 percent compost chance", recipe: "§l§6食谱:§r §7工作台 (无特定摆放)§r\n[Wheat] + [Sugar] + [Beetroot] + [Cocoa Beans] + [Butter]\n§7= Beetroot Brownie x1§r" }
        }}
    }},
    ...
    "Toasts, Jellies & Juices": { icon: "textures/items/sweet_berry_toast", subcategories: {
        "Toasts": { icon: "textures/items/sweet_berry_toast", items: {
            "Sweet Berry Toast": { icon: "textures/items/sweet_berry_toast", desc: "Crispy toast spread with sweet berry jam.", obtain: "Sweet Berries + Bread (无特定摆放).", hunger: "6 (3 点)", saturation: "1.2 (Normal)", other: "30 percent compost chance", recipe: "§l§6食谱:§r §7工作台 (无特定摆放)§r\n[Sweet Berries] + [Bread]\n§7= Sweet Berry Toast x1§r" },
            "Apple Toast": { icon: "textures/items/apple_toast", desc: "Toast topped with sliced apple.", obtain: "Apple + Bread (无特定摆放).", hunger: "6 (3 点)", saturation: "1.2 (Normal)", other: "30 percent compost chance", recipe: "§l§6食谱:§r §7工作台 (无特定摆放)§r\n[Apple] + [Bread]\n§7= Apple Toast x1§r" },
            "Glow Berry Toast": { icon: "textures/items/glow_berry_toast", desc: "Toast with glow berry spread that faintly glimmers.", obtain: "Glow Berries + Bread (无特定摆放).", hunger: "6 (3 点)", saturation: "1.2 (Normal)", other: "30 percent compost chance", recipe: "§l§6食谱:§r §7工作台 (无特定摆放)§r\n[Glow Berries] + [Bread]\n§7= Glow Berry Toast x1§r" },
            "Ghostberry Toast": { icon: "textures/items/ghostberry_toast", desc: "A pale, eerie toast made with ghostberries.", obtain: "Ghostberries + Bread (无特定摆放).", hunger: "6 (3 点)", saturation: "1.2 (Normal)", other: "30 percent compost chance", recipe: "§l§6食谱:§r §7工作台 (无特定摆放)§r\n[Ghostberries] + [Bread]\n§7= Ghostberry Toast x1§r" },
            "Inkberry Toast": { icon: "textures/items/inkberry_toast", desc: "Dark purple toast with inkberry spread.", obtain: "Inkberries + Bread (无特定摆放).", hunger: "6 (3 点)", saturation: "1.2 (Normal)", other: "30 percent compost chance", recipe: "§l§6食谱:§r §7工作台 (无特定摆放)§r\n[Inkberries] + [Bread]\n§7= Inkberry Toast x1§r" },
            "Gooseberry Toast": { icon: "textures/items/gooseberry_toast", desc: "Toast with tart gooseberry jam.", obtain: "Gooseberries + Bread (无特定摆放).", hunger: "6 (3 点)", saturation: "1.2 (Normal)", other: "30 percent compost chance", recipe: "§l§6食谱:§r §7工作台 (无特定摆放)§r\n[Gooseberries] + [Bread]\n§7= Gooseberry Toast x1§r" },
            "Cherry Toast": { icon: "textures/items/cherry_toast", desc: "Toast topped with fresh cherries.", obtain: "Cherries + Bread (无特定摆放).", hunger: "6 (3 点)", saturation: "1.2 (Normal)", other: "30 percent compost chance", recipe: "§l§6食谱:§r §7工作台 (无特定摆放)§r\n[Cherries] + [Bread]\n§7= Cherry Toast x1§r" },
            "Plum Toast": { icon: "textures/items/plum_toast", desc: "Toast with sweet plum jam.", obtain: "Plum + Bread (无特定摆放).", hunger: "6 (3 点)", saturation: "1.2 (Normal)", other: "30 percent compost chance", recipe: "§l§6食谱:§r §7工作台 (无特定摆放)§r\n[Plum] + [Bread]\n§7= Plum Toast x1§r" },
            "Chorus Fruit Toast": { icon: "textures/items/chorus_fruit_toast", desc: "Toast with chorus fruit. Teleports on item consumption.", obtain: "Chorus Fruit + Bread (无特定摆放).", hunger: "6 (3 点)", saturation: "1.2 (Normal)", other: "Teleports on item consumption\n30 percent compost chance", recipe: "§l§6食谱:§r §7工作台 (无特定摆放)§r\n[Chorus Fruit] + [Bread]\n§7= Chorus Fruit Toast x1§r" }
        }},
        "Jellies": { icon: "textures/items/sweet_berry_jelly", items: {
            "Sweet Berry Jelly": { icon: "textures/items/sweet_berry_jelly", desc: "A wobbly jelly made from sweet berries.", obtain: "Sweet Berries x2 + Sugar x2 + Empty Jar.", hunger: "6 (3 点)", saturation: "0.6 (Low)", other: "Stacks to 16", recipe: "§l§6食谱:§r §7工作台§r\n[ ][Sweet Berries][ ]\n[Sugar][Empty Jar][Sugar]\n[ ][Sweet Berries][ ]\n§7= Sweet Berry Jelly x1§r" },
            "Apple Jelly": { icon: "textures/items/apple_jelly", desc: "A clear jelly with fresh apple flavor.", obtain: "Apple x2 + Sugar x2 + Empty Jar. Also works with Green Apple.", hunger: "6 (3 点)", saturation: "0.6 (Low)", other: "Stacks to 16", recipe: "§l§6食谱:§r §7工作台§r\n[ ][Apple][ ]\n[Sugar][Empty Jar][Sugar]\n[ ][Apple][ ]\n§7= Apple Jelly x1§r\n§7Also works with Green Apple§r" },
            "Glow Berry Jelly": { icon: "textures/items/glow_berry_jelly", desc: "A luminous jelly that glows faintly.", obtain: "Glow Berries x2 + Sugar x2 + Empty Jar.", hunger: "6 (3 点)", saturation: "0.6 (Low)", other: "Stacks to 16", recipe: "§l§6食谱:§r §7工作台§r\n[ ][Glow Berries][ ]\n[Sugar][Empty Jar][Sugar]\n[ ][Glow Berries][ ]\n§7= Glow Berry Jelly x1§r" },
            "Ghostberry Jelly": { icon: "textures/items/ghostberry_jelly", desc: "A translucent, ghostly jelly.", obtain: "Ghostberries x2 + Sugar x2 + Empty Jar.", hunger: "6 (3 点)", saturation: "0.6 (Low)", other: "Stacks to 16", recipe: "§l§6食谱:§r §7工作台§r\n[ ][Ghostberries][ ]\n[Sugar][Empty Jar][Sugar]\n[ ][Ghostberries][ ]\n§7= Ghostberry Jelly x1§r" },
            "Inkberry Jelly": { icon: "textures/items/inkberry_jelly", desc: "A dark purple jelly with deep flavor.", obtain: "Inkberries x2 + Sugar x2 + Empty Jar.", hunger: "6 (3 点)", saturation: "0.6 (Low)", other: "Stacks to 16", recipe: "§l§6食谱:§r §7工作台§r\n[ ][Inkberries][ ]\n[Sugar][Empty Jar][Sugar]\n[ ][Inkberries][ ]\n§7= Inkberry Jelly x1§r" },
            "Gooseberry Jelly": { icon: "textures/items/gooseberry_jelly", desc: "A tart green jelly with gooseberry.", obtain: "Gooseberries x2 + Sugar x2 + Empty Jar.", hunger: "6 (3 点)", saturation: "0.6 (Low)", other: "Stacks to 16", recipe: "§l§6食谱:§r §7工作台§r\n[ ][Gooseberries][ ]\n[Sugar][Empty Jar][Sugar]\n[ ][Gooseberries][ ]\n§7= Gooseberry Jelly x1§r" },
            "Cherry Jelly": { icon: "textures/items/cherry_jelly", desc: "A bright red jelly with cherry flavor.", obtain: "Cherries x2 + Sugar x2 + Empty Jar.", hunger: "6 (3 点)", saturation: "0.6 (Low)", other: "Stacks to 16", recipe: "§l§6食谱:§r §7工作台§r\n[ ][Cherries][ ]\n[Sugar][Empty Jar][Sugar]\n[ ][Cherries][ ]\n§7= Cherry Jelly x1§r" },
            "Plum Jelly": { icon: "textures/items/plum_jelly", desc: "A rich purple jelly made with plums.", obtain: "Plum x2 + Sugar x2 + Empty Jar.", hunger: "6 (3 点)", saturation: "0.6 (Low)", other: "Stacks to 16", recipe: "§l§6食谱:§r §7工作台§r\n[ ][Plum][ ]\n[Sugar][Empty Jar][Sugar]\n[ ][Plum][ ]\n§7= Plum Jelly x1§r" },
            "Chorus Fruit Jelly": { icon: "textures/items/chorus_fruit_jelly", desc: "A strange jelly that shimmers with End energy. Teleports on item consumption.", obtain: "Chorus Fruit x2 + Sugar x2 + Empty Jar.", hunger: "6 (3 点)", saturation: "0.6 (Low)", other: "Teleports on item consumption\nStacks to 16", recipe: "§l§6食谱:§r §7工作台§r\n[ ][Chorus Fruit][ ]\n[Sugar][Empty Jar][Sugar]\n[ ][Chorus Fruit][ ]\n§7= Chorus Fruit Jelly x1§r" }
        }},
        "Juices": { icon: "textures/items/sweet_berry_juice", items: {
            "Sweet Berry Juice": { icon: "textures/items/sweet_berry_juice", desc: "A refreshing juice made from sweet berries.", obtain: "Water Bottle + Sweet Berries + Sugar (无特定摆放).", hunger: "4 (2 点)", saturation: "0.2 (Poor)", other: "Stacks to 16", recipe: "§l§6食谱:§r §7工作台 (无特定摆放)§r\n[Water Bottle] + [Sweet Berries] + [Sugar]\n§7= Sweet Berry Juice x1§r" },
            "Apple Juice": { icon: "textures/items/apple_juice", desc: "Crisp and refreshing apple juice.", obtain: "Water Bottle + Apple + Sugar (无特定摆放). Also works with Green Apple.", hunger: "4 (2 点)", saturation: "0.2 (Poor)", other: "Stacks to 16", recipe: "§l§6食谱:§r §7工作台 (无特定摆放)§r\n[Water Bottle] + [Apple] + [Sugar]\n§7= Apple Juice x1§r\n§7Also works with Green Apple§r" },
            "Glow Berry Juice": { icon: "textures/items/glow_berry_juice", desc: "A juice that glows with a warm light.", obtain: "Water Bottle + Glow Berries + Sugar (无特定摆放).", hunger: "4 (2 点)", saturation: "0.2 (Poor)", other: "Stacks to 16", recipe: "§l§6食谱:§r §7工作台 (无特定摆放)§r\n[Water Bottle] + [Glow Berries] + [Sugar]\n§7= Glow Berry Juice x1§r" },
            "Ghostberry Juice": { icon: "textures/items/ghostberry_juice", desc: "A pale, ethereal juice with ghostberries.", obtain: "Water Bottle + Ghostberries + Sugar (无特定摆放).", hunger: "4 (2 点)", saturation: "0.2 (Poor)", other: "Stacks to 16", recipe: "§l§6食谱:§r §7工作台 (无特定摆放)§r\n[Water Bottle] + [Ghostberries] + [Sugar]\n§7= Ghostberry Juice x1§r" },
            "Inkberry Juice": { icon: "textures/items/inkberry_juice", desc: "A dark juice that stains everything it touches.", obtain: "Water Bottle + Inkberries + Sugar (无特定摆放).", hunger: "4 (2 点)", saturation: "0.2 (Poor)", other: "Stacks to 16", recipe: "§l§6食谱:§r §7工作台 (无特定摆放)§r\n[Water Bottle] + [Inkberries] + [Sugar]\n§7= Inkberry Juice x1§r" },
            ...
            "Chorus Fruit Juice": { icon: "textures/items/chorus_fruit_juice", desc: "A fizzy juice with chorus fruit. Teleports on item consumption.", obtain: "Water Bottle + Chorus Fruit + Sugar (无特定摆放).", hunger: "4 (2 点)", saturation: "0.2 (Poor)", other: "Teleports on item consumption\nStacks to 16", recipe: "§l§6食谱:§r §7工作台 (无特定摆放)§r\n[Water Bottle] + [Chorus Fruit] + [Sugar]\n§7= Chorus Fruit Juice x1§r" }
        }}
    }},
...
"Other Foods": { icon: "textures/items/beef_sandwich", items: {
    ...
    "作物": { icon: "textures/items/corn", items: {
        ...
        "White Pumpkin": { icon: "textures/blocks/pumpkins_melons/white_pumpkin_side", desc: "A pale pumpkin found in the Pale Garden. Can be carved with shears, crafted into seeds, pie, or used to spawn Copper, Iron, and Snow Golems.", obtain: "Generates in Pale Garden biomes.", hunger: null, saturation: null, other: "Can spawn Copper, Iron, and Snow Golems\nCarve with Shears to get Carved White Pumpkin", related: [
            ...
            { name: "White Pumpkin Pie", icon: "textures/items/white_pumpkin_pie", desc: "A creamy pie made from white pumpkin. Can be placed.", obtain: "White Pumpkin + Sugar + Egg (any type) - shapeless.", hunger: "8 (4 点)", saturation: "0.6 (Low)", other: "Placeable\n100 percent compost chance", 食谱: "§l§6食谱:§r §7工作台 (Shapeless)§r\n[White Pumpkin] + [Sugar] + [Egg]\n§7= White Pumpkin Pie x1§r" },
